function [ ] = multiCameraWaterfall( dataset, cameras, imageFunctions, bitDepths, shots, isScan, doAvg, cutoffs )
    ...
    for i = 1:Ncams
        ...
        if isScan
            ...
            set(gca, 'XTickLabel', num2str(uniqueStepValues','%.1f'));
        ...
        if (isELAN && ( isfield(data.raw.metadata.E200_state, 'XPS_LI20_MC01_M5_RBV') ||  (0 && isfield(data.raw.metadata.E200_state, 'XPS_LI20_DWFA_M5') ) ) ) || isWLAN || isCFAR
